...
function activate(context) {
    ...
    statusBarItem.show();
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('bobHelper.connect', () => connect()), vscode.commands.registerCommand('bobHelper.disconnect', () => disconnect()), vscode.commands.registerCommand('bobHelper.status', () => showStatus()), vscode.commands.registerCommand('bobHelper.discoverCommands', () => discoverCommands()), outputChannel, statusBarItem);
